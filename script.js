...
const desserts = ['ice cream', 'cake', 'pie'];
...
for(let index = 0; index < coder.length; index++){
    console.log(typeof(coder[index]));
}
...
if(firstNum < secondNum) {
    console.log('firstNum less than secondNum');
} else if(firstNum > secondNum) {
    console.log('firstNum more than secondNum');
} else {
    console.log('firstNum equal secondNum');
}
...
let ifMoreThan = secondNum > firstNum;
console.log(ifMoreThan);
